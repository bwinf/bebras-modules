(function() {
    ...
    window.lang = {
        ...
        strings: {
            ...
            de: {
                'score': 'Punkte',
                'grader_msg': 'Du hast %1 Punkte.',
                'wrong_answer_msg': 'Leider falsch.',
                'wrong_answer_msg_partial_feedback': 'Leider falsch. Hier ist ein Hinweis:',
                'wrong_answer_msg_not_answered': 'Du hast die Frage nicht beantwortet.',
                'wrong_fill_gaps_msg': 'Du hast %% falsche Antworten (in rot markiert).',
                'validate': 'Abschicken',
                'solution': 'Lösung ansehen',
                'restart': 'Neustarten',
                'restart_scratch': 'Von vorne anfangen',
                'restart_current': 'Von hier neu starten',
                'return_to_top': 'Zurück zur Übersicht',
                ...
                'error_string': 'Keine Zeichenkette',
                'placeholder_regexp': 'Text eingeben',
                'error_regexp': 'Falsches Format',
                'error_grading': 'Fehler mein übermitteln der Antwort. Bitte probier es noch einmal.',
