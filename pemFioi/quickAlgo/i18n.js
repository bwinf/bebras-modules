...
var quickAlgoLanguageStrings = {
   ...
   de: {
      ...
      description: {
         ...
         else: "Schlüsselwort, um einen Anweisungsblock auszuführen, wenn die vorher stehende Bedingungen (if / elif) nicht erfüllt sind.",
         elif: "Schlüsselwort, um einer bedingten Anweisung einen weiteren Fall hinzuzufügen",
         for: "Schlüsselwort, um einen Anweisungsblock eine bestimmte Anzahl oder für alle Elemente einer Folge zu wiederholen",
         while: "Schlüsselwort, um einen Anweisungsblock so lange zu wiederholen, wie eine Bedingung erfüllt ist",
         not: "Logischer Operator für die Verneinung",
         and: "Logischer UND-Operator",
         or: "Logischer ODER-Operator",
         def: "Schlüsselwort, um eine Funktion zu definieren",
         len: "Funktion, die die Länge des übergebenen Elements zurückgibt"
      },
      controls: {
         backToFirst: "Zurücksetzen",
         playPause: "Start / Pause",
         nextStep: "Einzelschritt",
         goToEnd: "Bis zum Ende ausführen",
         displaySpeedSlider: "Geschwindigkeit ändern",
         hideSpeedSlider: "Geschwindigkeitsregler ausblenden",
         speedSlower: "Langsamer",
         speedFaster: "Schneller"
      },
      exerciseTypeAbout: {
         default: "Aufgabe bereitgestellt von BWINF</a>",
         "Quick-Pi": "<a href='https://quick-pi.org/'>Quick-Pi</a> ist ein Projekt von " +
            "<a href='http://www.france-ioi.org/'>France-IOI</a>"
      },
      invalidContent: "Ungültiger Inhalt",
      unknownFileType: "Ungültiger Dateityp",
      ...
      runProgram: "Testen",
      stopProgram: "|<",
      speedSliderSlower: "Langsamer",
      speedSliderFaster: "Schneller",
      ...
      blocklyLanguage: "Blockly",
      javascriptLanguage: "Javascript",
      importFromBlockly: "Aus Blockly erzeugen",
      ...
      reloadProgram: "Laden",
      restart: "Neustarten",
      loadBestAnswer: "Beste Lösung laden",
      saveProgram: "Speichern",
      copy: "Kopieren",
      paste: "Einfügen",
      blocklyToPython: "Python-Code anzeigen",
      blocklyToPythonTitle: "Python-Code",
      blocklyToPythonIntro: "",
      blocklyToPythonPassComment: '# Befehle hier eingeben',
      svgExport: "Ansicht als SVG exportieren",
      ...
      variablesAllowed: "Du darfst Variablen verwenden.",
