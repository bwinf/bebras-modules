...
//** @export */ Blockly.Msg.de.INVALID_NAME="Ungültiger Name. Erlaubt sind Buchstaben [a-z,A-Z], Zahlen [0-9] und Unterstriche '_'.";
//** @export */ Blockly.Msg.de.DICTS_CREATE_EMPTY_TITLE="Ein leeres Wörterbuch erstellen", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_CONTAINER_TITLE_ADD="Ein Wörterbuch erstellen", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_CONTAINER_TOOLTIP="", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_INPUT_WITH="ein Wörterbuch erstellen mit:", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_ITEM_KEY="Schlüssel", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_ITEM_MAPPING=":", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_ITEM_TITLE="Schlüssel/Wert", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_ITEM_TOOLTIP="", //untested
//** @export */ Blockly.Msg.de.DICTS_CREATE_WITH_TOOLTIP="", //untested
//** @export */ Blockly.Msg.de.DICT_GET="den Schlüssel abrufen", //untested
//** @export */ Blockly.Msg.de.DICT_GET_TO="von", //untested
//** @export */ Blockly.Msg.de.DICT_KEYS="Schlüsselliste von", //untested
//** @export */ Blockly.Msg.de.DICT_SET_TITLE="den Schlüssel zuweisen", //untested
//** @export */ Blockly.Msg.de.DICT_SET_OF="des Wörterbuchs", //untested
//** @export */ Blockly.Msg.de.DICT_SET_TO="nach", //untested
//** @export */ Blockly.Msg.de.TEXT_PRINT_NOEND_TITLE="zeige %1 an",
//** @export */ Blockly.Msg.de.TEXT_PRINT_NOEND_TOOLTIP="Text, eine Zahl oder einen anderen angegebenen Wert ohne Zeilenumbruch anzeigen.",
//** @export */ Blockly.Msg.de.TEXT_EVAL_TITLE="auswerten",
//** @export */ Blockly.Msg.de.TEXT_EVAL_TOOLTIP="Bewertet den angegebenen arithmetischen Ausdruck.",
//** @export */ Blockly.Msg.de.TEXT_EVAL_INVALID="Achtung: %1; Dieser Block wird 'falsch' zurückgeben!",
//** @export */ Blockly.Msg.de.EVAL_ERROR_SEMICOLON="Das Semikolon ';' ist nicht erlaubt.",
//** @export */ Blockly.Msg.de.EVAL_ERROR_SYNTAX="Der Ausdruck ist syntaktisch nicht gültig.",
//** @export */ Blockly.Msg.de.EVAL_ERROR_TYPE="Diese Art von Ausdruck (%1) ist nicht erlaubt.",
//** @export */ Blockly.Msg.de.EVAL_ERROR_VAR="Dieser Ausdruck verwendet eine nicht definierte Variable '%1'.",
...
//** @export */ Blockly.Msg.de.LISTS_SORT_PLACE_MSG="Liste %1 an Ort und Stelle sortieren.",
//** @export */ Blockly.Msg.de.LISTS_SORT_PLACE_TOOLTIP="Sortiert die Liste '%1' und bearbeitet sie direkt.",
//** @export */ Blockly.Msg.de.INPUT_NUM="eine Zahl allein in einer Zeile lesen",
//** @export */ Blockly.Msg.de.INPUT_NUM_TOOLTIP="Liest eine einzelne Zahl in einer Zeile aus dem Programmeintrag.",
...
//** @export */ Blockly.Msg.de.INPUT_NUM_NEXT="eine Zahl lesen",
//** @export */ Blockly.Msg.de.INPUT_NUM_NEXT_TOOLTIP="Liest die nächste Zahl aus dem Programmeintrag.",
//** @export */ Blockly.Msg.de.INPUT_CHAR="ein Zeichen lesen",
//** @export */ Blockly.Msg.de.INPUT_CHAR_TOOLTIP="Liest ein Zeichen aus dem Programmeintrag.",
//** @export */ Blockly.Msg.de.INPUT_WORD="ein Wort lesen",
//** @export */ Blockly.Msg.de.INPUT_WORD_TOOLTIP="Liest ein Wort aus dem Programmeintrag.",
//** @export */ Blockly.Msg.de.INPUT_LINE="eine Zeile lesen",
//** @export */ Blockly.Msg.de.INPUT_LINE_TOOLTIP="Liest eine Zeile aus dem Programmeintrag.",
//** @export */ Blockly.Msg.de.DATA_REPLACEITEMOFLIST_TITLE="Eintrag %1 in der Liste %2 durch %3 ersetzen",
//** @export */ Blockly.Msg.de.DATA_ITEMOFLIST_TITLE="Element %1 in %2",
//** @export */ Blockly.Msg.de.DATA_LISTREPEAT_TITLE="Liste %1 mit %2 wiederholt %3 initialisieren",
//** @export */ Blockly.Msg.de.TABLES_2D_INIT="2D-Array %1 mit %2 Zeilen und %3 Spalten initialisieren, das %4 enthält.",
//** @export */ Blockly.Msg.de.TABLES_2D_INIT_TOOLTIP="Erstellt ein Array mit der angegebenen Anzahl an Zeilen und Spalten und initialisiert jedes Feld mit dem angegebenen Wert.",
//** @export */ Blockly.Msg.de.TABLES_2D_SET="in %1[%2] [%3] %4 setzen",
//** @export */ Blockly.Msg.de.TABLES_2D_SET_TOOLTIP="Setzt den Wert in das Feld [Zeile] [Spalte] der Tabelle %1.",
//** @export */ Blockly.Msg.de.TABLES_2D_GET="%1[%2] [%3]",
//** @export */ Blockly.Msg.de.TABLES_2D_GET_TOOLTIP="Ruft den Wert im Feld [Zeile] [Spalte] der Tabelle %1 ab.",
//** @export */ Blockly.Msg.de.TABLES_3D_INIT="3D-Array %1 mit %2 Ebenen, %3 Zeilen, %4 Spalten, die %5 enthalten, initialisieren.",
//** @export */ Blockly.Msg.de.TABLES_3D_INIT_TOOLTIP="Erstellt ein Array mit der angegebenen Anzahl an Zeilen, Spalten und Ebenen und initialisiert jedes Feld mit dem angegebenen Wert.",
//** @export */ Blockly.Msg.de.TABLES_3D_SET="in %1[%2] [%3] [%4] %5 setzen",
//** @export */ Blockly.Msg.de.TABLES_3D_SET_TOOLTIP="Setzt den Wert in das Feld [Ebene] [Zeile] [Spalte] der Tabelle %1.",
//** @export */ Blockly.Msg.de.TABLES_3D_GET="%1[%2] [%3] [%4]",
//** @export */ Blockly.Msg.de.TABLES_3D_GET_TOOLTIP="Ruft den Wert im Feld [Ebene] [Zeile] [Spalte] der Tabelle %1 ab.",
//** @export */ Blockly.Msg.de.TABLES_VAR_NAME="Tabelle",
//** @export */ Blockly.Msg.de.TABLES_TOO_BIG="Dimensionen der Tabelle sind zu groß!",
//** @export */ Blockly.Msg.de.TABLES_OUT_OF_BOUNDS="Versuch, auf ein Feld außerhalb der Tabelle zuzugreifen!",
//** @export */ Blockly.Msg.de.MATH_DIVISIONFLOOR_SYMBOL=" // ",
//** @export */ Blockly.Msg.de.MATH_ARITHMETIC_TOOLTIP_DIVIDEFLOOR="Gibt den ganzzahligen Teil der Division der beiden Zahlen zurück.",
...
/** @export */ Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Führt eine Anweisung aus, falls eine Bedingung True ist.";
/** @export */ Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Führt die erste Anweisung aus, falls eine Bedingung True ist.  Führt ansonsten die zweite Anweisung aus.";
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Führt Anweisungen aus solange die Bedingung False ist.";
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Führt Anweisungen aus solange die Bedingung True ist.";
...
/** @export */ Blockly.Msg.LISTS_GET_INDEX_FIRST = "erstes Element";
...
/** @export */ Blockly.Msg.LISTS_GET_INDEX_LAST = "letztes Element";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_RANDOM = "zufälliges Element";
...
/** @export */ Blockly.Msg.LISTS_ISEMPTY_TOOLTIP = "Ist True, falls die Liste leer ist.";
...
/** @export */ Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = "Ist entweder True oder False";
/** @export */ Blockly.Msg.LOGIC_BOOLEAN_TRUE = "True";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Ist True, falls beide Werte gleich sind.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Ist True, falls der erste Wert größer als der zweite Wert ist.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Ist True, falls der erste Wert größer als oder gleich groß wie der zweite Wert ist.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Ist True, falls der erste Wert kleiner als der zweite Wert ist.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Ist True, falls der erste Wert kleiner als oder gleich groß wie der zweite Wert ist.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Ist True, falls beide Werte unterschiedlich sind.";
/** @export */ Blockly.Msg.LOGIC_NEGATE_TITLE = "nicht %1";
/** @export */ Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Ist True, falls der Eingabewert False ist.  Ist False, falls der Eingabewert True ist.";
...
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Ist True, falls beide Werte True sind.";
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Ist True, falls einer der beiden Werte wTrueahr ist.";
/** @export */ Blockly.Msg.LOGIC_TERNARY_CONDITION = "prüfe";
/** @export */ Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "falls False";
/** @export */ Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "falls True";
/** @export */ Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Überprüft eine Bedingung \"prüfe\". Falls die Bedingung True ist, wird der \"falls True\" Wert zurückgegeben, andernfalls der \"falls False\" Wert";
...
/** @export */ Blockly.Msg.MATH_IS_TOOLTIP = "Überprüft ob eine Zahl gerade, ungerade, eine Primzahl, ganzzahlig, positiv, negativ oder durch eine zweite Zahl teilbar ist.  Gibt True oder False zurück.";
...
/** @export */ Blockly.Msg.LISTS_NUMBER_SUFFIX = "";
...
/** @export */ Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Gibt den zweiten Wert zurück und verlässt die Funktion, falls der erste Wert True ist.";
...
/** @export */ Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "Ist True, falls der Text keine Zeichen enthält ist.";
...
/** @export */ Blockly.Msg.VARIABLES_HUE = "#a5416b";
